...
images = []
labels = np.array([2,0,0,3,3,9,9,6,6,8,8,6,6,1,1,9,9,6,6,5,5,8,8,7,7,7,7,5,5,7,7,1,1,3,3,4,4,2,2]) #Picture label array
trainedlabels = labels[:,np.newaxis]
picnum = 39 #Number of training images
img_data = []
...
for i in range(picnum):
	tempimg = cv2.imread('./images/%1d.png' %i) #Reads image with the name of int(i).png
